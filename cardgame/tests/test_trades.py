...
class TradeTestCase(TestCase):
    ...
    def test_invalid_trade_not_cancelled(self):
        ...
        self.assertEqual(Trade.objects.filter(offered_card=self.card1).count(),1)
    ...
    def test_accepting_targeted_trade(self):
        ...
        self.assertTrue(self.card2 not in self.user_profile2.user_profile_collected_cards.all())
